...
for school in charters:
	try:
		enrollment		= charters[school_IRN]['# of students']
		teachers		= charters[school_IRN]['# of FT teachers']
		poverty			= charters[school_IRN]['Poverty Enrollment']
		disabled		= charters[school_IRN]['Disable Enrollment']
		gifted			= charters[school_IRN]['Gifted Enrollment']
		white			= charters[school_IRN]['White Enrollment']
