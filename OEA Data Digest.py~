		...
		if len(row[0]) < 1:
			...
			if IRN in charters:
				...
				while curr_cell < num_cells:
					...
					classroom_percent	= "%.2f" % classroom_percent
...
while curr_row < num_rows:
	...
	if header_row:
		...
		if len(row[0]) < 1:
			...
			school_grade			= worksheet.cell_value(curr_row, 16)
			...
			charters[school_IRN]['City']		= school_city
			charters[school_IRN]['Avg Grade']	= school_grade
...
while curr_row < num_rows:
	...
	if header_row:
		...
		if len(row[0]) < 1:
			...
			district_grade			= worksheet.cell_value(curr_row, 11)
			...
			districts[district_IRN]['City']		= district_city
			districts[district_IRN]['Avg Grade']	= district_grade
...
for district in districts:
	...
	for col in headers:
		...
		row.append(data)
	try:
		city_state_zip	= districts[district]['District Report Card - City and Zip code']
		group			= city_state_zip.split(",")
		city			= group[0]
		group			= group[1].split(" ")
		state			= group[0]
...
############ OUTPUT KNOW YOUR CHARTERS TABLES ############
